...
BOOL CInsertQueryDlg::OnInitDialog()
{
	...
	p_m_tabScenarioTab3 = new CInsertQueryDlgTab3;
	p_m_tabScenarioTab3->Create(IDD_DIALOG_INSERT_QUERY_TAB3, &m_tabScenario);
	p_m_tabScenarioTab3->MoveWindow(0, 20, rect.Width(), rect.Height());
	p_m_tabScenarioTab3->ShowWindow(SW_HIDE);

	p_m_tabScenarioTab4 = new CInsertQueryDlgTab4;
	p_m_tabScenarioTab4->Create(IDD_DIALOG_INSERT_QUERY_TAB4, &m_tabScenario);
